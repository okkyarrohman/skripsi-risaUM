<nav class="bg-[#1E3A8A] text-white shadow">
    <div class="w-full flex justify-between px-8 py-3">
        ...
        <div class="space-x-8 text-sm sm:text-base font-bold flex items-center">
            ...
            class="relative inline-block pb-1
                    {{ request()->routeIs('landing.guide') ? 'border-b-3 border-white' : 'hover:text-gray-300' }}">
                Panduan Admin
            </a>
            ...
            <form action="{{ route('auth.logout') }}" method="POST" class="inline">
                @csrf
                <button type="submit" 
                        class="relative inline-flex hover:text-gray-300 items-center pb-1 bg-transparent border-none text-white hover:border-b-3 hover:border-white cursor-pointer font-bold text-sm sm:text-base">
                    Logout
