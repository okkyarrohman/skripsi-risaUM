<footer class="bg-[#1E3A8A] text-gray-700 shadow-inner">
    <div class="container mx-auto flex flex-col sm:flex-row justify-between gap-6 p-6 text-sm text-white px-20">
        ...
        <div class="flex flex-col text-left">
            <p class="font-bold text-white mb-2 text-2xl">UPT Perpustakaan UM</p>

            <div class="mb-4">
                <div class="flex">
                    <span class="min-w-[160px] font-semibold">Jam Layanan:</span>
                    <span>Senin–Kamis 07.00–18.00</span>
                </div>
                <div class="flex">
                    <span class="min-w-[160px]"></span>
            ...
            <div class="text-white py-2">
                <div class="flex items-center gap-2">
                    <span class="min-w-[160px] font-semibold">Hubungi kami lewat:</span>
                ...
                <div class="flex items-center gap-2 py-1">
                    ...
                    <span class="flex items-center gap-2">
                        <!-- Email Icon -->
                        <svg class="w-5 h-5 text-white" xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 16 16">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <span class="flex items-center gap-2">
                        ...
                        <a href="https://api.whatsapp.com/send?phone=6282140533038&text=" target="_blank" class="hover:underline">082140533038</a>
                    </span>
                </div>
            </div>
