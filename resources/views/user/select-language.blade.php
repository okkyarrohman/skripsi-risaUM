...
<section class="max-w-6xl mx-auto px-4 py-20">
    ...
    <div class="flex flex-col sm:flex-row justify-center gap-16">
        <a href="{{ route('cari.audio', ['language' => 'id']) }}" 
            class="w-full sm:w-48 h-48 bg-[#090445] rounded-2xl p-3 flex flex-col items-center justify-center shadow-lg hover:scale-110 hover:bg-[#1119B3] transition-transform text-center"
            role="button"
