...
<div class="py-16 md:py-36 p-6 flex flex-col justify-center items-center bg-[#06003F]">
    <p class="text-lg font-bold mb-2 text-white text-center">Pencarian Audio Abstrak Tugas Akhir dalam Bahasa Indonesia</p>
    ...
    <div class="bg-white shadow-md rounded-lg px-6 py-6 w-full max-w-lg">
       <form method="GET" action="{{ route('cari.audio') }}" class="flex items-center gap-3">
